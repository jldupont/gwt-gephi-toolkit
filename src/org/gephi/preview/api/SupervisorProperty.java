 ...
 */
public final class SupervisorProperty {

    protected Property property;
    protected String category;

    SupervisorProperty(Property property, String category) {
     ...
     */
    /*
    public static SupervisorProperty createProperty(Supervisor supervisor, Class valueType, String propertyName, String propertyCategory, String propertyDescription) throws NoSuchMethodException {
        ...
        return new SupervisorProperty(property, propertyCategory);
    }
	*/
    /**
     ...
     */
    /*
    public static SupervisorProperty createProperty(Supervisor supervisor, Class valueType, String propertyName, String propertyCategory, String propertyDescription, String getMethod, String setMethod) throws NoSuchMethodException {
	...
	*/
     ...
     */
    /*
    public static SupervisorProperty createProperty(Supervisor supervisor, Class valueType, String propertyName, String propertyCategory, String propertyDescription, Class<? extends PropertyEditor> editorClass) throws NoSuchMethodException {
        PropertySupport.Reflection property = new PropertySupport.Reflection(
                supervisor, valueType, propertyName);
	...
	*/
     ...
     */
    /*
    public static SupervisorProperty createProperty(Supervisor supervisor, Class valueType, String propertyName, String propertyCategory, String propertyDescription, String getMethod, String setMethod, Class<? extends PropertyEditor> editorClass) throws NoSuchMethodException {
        PropertySupport.Reflection property = new PropertySupport.Reflection(
                supervisor, valueType, getMethod, setMethod);
