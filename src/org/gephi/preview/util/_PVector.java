 ...
 */
public class _PVector implements Serializable {
   ...
   */
  public _PVector(float x, float y, float z) {
    this.x = x;
    this.y = y;
    this.z = z;
  }
   ...
   * @param  y the y coordinate.
   */
  public _PVector(float x, float y) {
    this.x = x;
    this.y = y;
    this.z = 0;
  }
 ...
 */
   ...
   */
  static public _PVector add(_PVector v1, _PVector v2) {
   ...
   */
  static public _PVector add(_PVector v1, _PVector v2, _PVector target) {
    if (target == null) {
      target = new _PVector(v1.x + v2.x,v1.y + v2.y, v1.z + v2.z);
    } else {
 ...
 */
   ...
   */
  static public _PVector sub(_PVector v1, _PVector v2) {
 ...
 * @param target ???
 */
  static public _PVector sub(_PVector v1, _PVector v2, _PVector target) {
    if (target == null) {
      target = new _PVector(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
    } else {
      target.set(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
   ...
   */
  static public _PVector mult(_PVector v, float n) {
   ...
   */
  static public _PVector mult(_PVector v, float n, _PVector target) {
    if (target == null) {
      target = new _PVector(v.x*n, v.y*n, v.z*n);
    } else {
   ...
   */
  static public _PVector mult(_PVector v1, _PVector v2) {
    return mult(v1, v2, null);
  }

  static public _PVector mult(_PVector v1, _PVector v2, _PVector target) {
    if (target == null) {
      target = new _PVector(v1.x*v2.x, v1.y*v2.y, v1.z*v2.z);
    } else {
      target.set(v1.x*v2.x, v1.y*v2.y, v1.z*v2.z);
   ...
   */
  static public _PVector div(_PVector v, float n) {
    return div(v, n, null);
  }
 ...
 * @param target ???
 */
  static public _PVector div(_PVector v, float n, _PVector target) {
    if (target == null) {
      target = new _PVector(v.x/n, v.y/n, v.z/n);
    } else {
      target.set(v.x/n, v.y/n, v.z/n);
   ...
   */
  static public _PVector div(_PVector v1, _PVector v2) {
    return div(v1, v2, null);
  }

  static public _PVector div(_PVector v1, _PVector v2, _PVector target) {
    if (target == null) {
      target = new _PVector(v1.x/v2.x, v1.y/v2.y, v1.z/v2.z);
    } else {
      target.set(v1.x/v2.x, v1.y/v2.y, v1.z/v2.z);
   ...
   */
  static public float dist(_PVector v1, _PVector v2) {
    float dx = v1.x - v2.x;
    float dy = v1.y - v2.y;
    float dz = v1.z - v2.z;
    return (float) Math.sqrt(dx*dx + dy*dy + dz*dz);
 ...
 * @param v2???
 */
  static public float dot(_PVector v1, _PVector v2) {
   ...
   */
  public _PVector cross(_PVector v) {
    return cross(v, null);
  }
   ...
   * @param target ???
   */
  public _PVector cross(_PVector v, _PVector target) {
    float crossX = y * v.z - v.y * z;
    float crossY = z * v.x - v.z * x;
    float crossZ = x * v.y - v.x * y;

    if (target == null) {
      target = new _PVector(crossX, crossY, crossZ);
    } else {
 ...
 * @param v2 ???
 */
  static public _PVector cross(_PVector v1, _PVector v2, _PVector target) {
   ...
   */
  public _PVector normalize(_PVector target) {
    if (target == null) {
      target = new _PVector();
    }
    float m = mag();
   ...
   * @return a new vector (if target was null), or target
   */
  public _PVector setMag(_PVector target, float len) {
   ...
   * @see _PApplet#cos(float)
   * @see _PApplet#tan(float)
   * @see _PApplet#radians(float)
   */
...
/**
   ...
   */
  public void lerp(_PVector v, float amt) {
    x = lerp(x,v.x,amt);
    y = lerp(y,v.y,amt);
  }
   ...
   * @param v2 the x, y, and z components of a PVector
   */
  static public float angleBetween(_PVector v1, _PVector v2) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof _PVector))
      return false;
    final _PVector p = (_PVector) obj;
